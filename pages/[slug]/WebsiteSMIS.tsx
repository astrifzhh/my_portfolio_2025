      ...
      <div className="max-w-screen-lg py-20 px-6 md:px-4 lg:px-0">
        ...
        <div>
          ...
          <TextGenerateEffect
            ...
            words={"School Management Information System"}
          />
          ...
          <div className="w-full">
            ...
            <div className="row lg:col">
              <div className="flex flex-col lg:flex-row mx-auto justify-center">
                ...
                <div className="py-8 lg:py-32 px-8 md:px-4 space-y-2 min-w-1.5">
                  <div>
                    <strong>Team </strong>
                  </div>
                  <div>1 UI UX Designer, 4 Fullstack</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col mt-6">
            ...
            <div className="p-8 border border-[#CBACF9] dark:border-[#2B313A] mt-12 rounded-lg">
              ...
              <div className="flex flex-row items-center justify-center gap-4 mt-8">
                <img
                  className="block mx-auto w-1/2 h-auto rounded-md lg:rounded-lg"
            ...
            <div className="p-8 border border-[#CBACF9] dark:border-[#2B313A] mt-12 rounded-lg">
              ...
              <div className="mt-8">
                <img
                  className="mx-auto rounded-md lg:rounded-lg"
                  // style={{
                  //   width: "50%",
                  //   height: "auto",
                  //   // transform: "scale(0)",
