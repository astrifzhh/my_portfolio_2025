          ...
          >
            <PinContainer title={link} href={link}>
              <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[20vh] mb-10">
                <div className="relative w-full h-full overflow-hidden lg:rounded-3xl bg-[#04071D]">
                  <img src="/bg.png" alt="bg-img" />
                </div>
                <img
                  src={img}
                  alt={title}
                  className="z-10 absolute lg:translate-y-4 md:-translate-y-4 sm:inset-auto sm:bottom-0"
                />
              </div>
